...
open class ScrollingTextView: NSView {
    ...
    private lazy var textFontAttributes: [NSAttributedStringKey: Any] = {
        return [NSAttributedStringKey.font: font ?? NSFont.systemFont(ofSize: 14)]
    }()
...
extension ScrollingTextView {
    override open func draw(_ dirtyRect: NSRect) {
        ...
        textFontAttributes[NSAttributedStringKey.foregroundColor] = textColor
